...
이미지 수정이 필요한 경우도 같은 `수정 요청하기` 템플릿을 사용합니다.

1. 이미지 파일을 이슈 본문에 드래그앤드롭으로 첨부
2. 생성된 첨부 URL을 `첨부 이미지 URL` 항목에 입력
3. 어느 페이지/어느 위치에 반영할지 함께 작성
...
[홈페이지](https://dglab.yonsei.ac.kr/)에 접속하여 변경사항이 잘 반영되었는지 확인합니다.
